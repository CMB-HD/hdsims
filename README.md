...
Download the full sky maps of the diffuse foregrounds and the discrete catalogs used in [Sehgal et al. (2010)](https://lambda.gsfc.nasa.gov/simulation/full_sky_sims_ov.html) at all frequencies. These data can be found here: (https://lambda.gsfc.nasa.gov/data/tools/simulations). These data can be downloading directly by running
