...
res = hp.nside2resol(8192, arcmin=True)
l_max = 12574
...
for component in ['radio','tSZ','kSZ','CIB']:
    print(component)
    for frequency in ['030','090','148','219','277','350']:
        print(frequency)
        target_path = f"/gpfs/projects/SehgalGroup/jange/final/output/{component}/{frequency}/{res}/"
        patch = enmap.read_map(f"/gpfs/projects/SehgalGroup/jange/final/output/{component}/{frequency}/{res}/inner_patch")
...
res = hp.nside2resol(4096, arcmin=True)
l_max = 6287
