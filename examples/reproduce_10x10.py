...
simlib.generate_hd_sims_and_calculate_powerspectra(save_intermediate_maps=True, save_intermediate_map_power=True, make_plots=True, plot_fdiff=True, use_fig_settings=True)
